...
public class GeneticSearch extends Object {
  ...
  protected Vector population;                     // ordered by fitness
  ...
  public void processOneGeneration() {
    ...
    Vector newPopulation = createNewMembers();  // generate new members
   ...
   *                        the population
   */
  protected void integratePopulation(Vector newPopulation) {
   ...
   *
   */
  protected void insertIntoPopulation(GeneticSearchObject newMember, Vector list) {
    try {
